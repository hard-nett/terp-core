...
import (
	...
	appparams "github.com/hard-nett/terp-node/v2/app/params"
)
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Produce the map of address to total terp balance, both staked and UnbondingStake
...
Example:
	terpd staked-to-csv ../balances.json ../airdrop.csv
`,
		Args: cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx := client.GetClientContextFromCmd(cmd)
