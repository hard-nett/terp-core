...
import (
	...
	helpers "github.com/hard-nett/terp-node/tests/interchaintest/helpers"
...
func TestTerpIBCHooks(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
	...
	// Create chain factory with Terp and terp2
	numVals := 1
	numFullNodes := 0

	cfg2 := terpConfig.Clone()
	cfg2.Name = "terp-counterparty"
