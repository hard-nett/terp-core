...
import (
	...
	"github.com/hard-nett/terp-node/v2/x/ibchooks/keeper"
	"github.com/hard-nett/terp-node/v2/x/ibchooks/types"
)
...
Example:
$ %s query ibc-hooks wasm-hooks-sender channel-42 terp12smx2wdlyttvyzvzg54y2vnqwq2qjatencyhtn
`,
				version.AppName,
			),
		),
